...
namespace FractionsExercise.Tests
{
    ...
    public class FractionCalculatorTests
    {
        ...
        {
            Assert.True(FractionCalculator.Add(new Fraction(0, 0), new Fraction(0, 0)).Equals(new Fraction(0, 0)));
        }

        [Test]
        public void Should_add_fractions_with_same_denominator()
        {
            Assert.True(FractionCalculator.Add(new Fraction(1, 4), new Fraction(2, 4)).Equals(new Fraction(3, 4)));
        }

        [Test]
        public void Should_add_fractions_with_different_denominator()
        {
            Assert.True(FractionCalculator.Add(new Fraction(1, 4), new Fraction(2, 5)).Equals(new Fraction(13, 20)));
        }
        ...
        {
            Assert.True(FractionCalculator.Add(new Fraction(addendNumerator, addendDenominator), new Fraction(augendNumerator, augendDenominator))
                .Equals(new Fraction(expectedNumerator, expectedDenominator))
                );
        }
        ...
        {
            Assert.True(FractionCalculator.Add(new Fraction(addendNumerator), new Fraction(augendNumerator))
                .Equals(new Fraction(expectedNumerator))
                );
        }
